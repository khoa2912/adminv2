...
const BannerPage = () => {
  ...
  useEffect(() => {
    ...
    let obj = listScreen.find((o) => o.screenSlug === "/banner");
    console.log("obj", obj);
    if (!obj) {
      navigate("/404");
    }
  ...
  const columns = [
    ...
    { field: "codeBanner", headerName: "Mã Banner", width: 150 },
    {
      ...
      renderCell: (params) => {
        return (
          <Image preview={false} src={`${params.row.image}`} width={200} />
        );
      },
      width: 300,
    },
          ...
          <div style={{ height: 600, width: "100%", marginLeft: "10px" }}>
            <DataGrid
              ...
              onSelectionModelChange={(ids) => {
                ...
                const selectedRows = bannerInPage.filter((row) =>
