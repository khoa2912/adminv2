...
const RoleActionPage = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: (params) => {
        return (
          <div className="rowitem" style={{ textAlign: "center" }}>
            {moment(params.value).format("HH:SS DD/MM/YYYY")}
          </div>
        );
      },
    },
  ...
  const handleChangeAction = (e) => {
    ...
    setListAction(typeof value === "string" ? value.split(",") : value);
  };
                    ...
                    <SelectMui
                      ...
                      renderValue={(selected) => {
                        const newArr = selected.map((element, index) => {
                          const a = action.actions.find(
                            (data) => data._id === element
                          );
                          return a.actionName;
                        });
                        selected = newArr;
                    ...
                    >
                      {action.actions.map((option) => (
                        ...
                        <MenuItem key={option._id} value={option._id}>
                          <Checkbox
                            checked={listAction.indexOf(option._id) > -1}
                          />
                      ...
                      >
                        {roleactionInPage.map((item) => (
                          <Option
                            ...
                            data={item.roleId}
                            text={
                              item.roleId === "63603cbd6fbb022774f83f9b"
                                ? "Admin"
                                : item.roleId === "63603cc76fbb022774f83fa0"
                                ? "Quản lý nhãn hàng"
                                : item.roleId === "63603cce6fbb022774f83fa5"
                                ? "Quản lý sản phẩm"
                                : item.roleId === "63603cd76fbb022774f83faa"
                                ? "Quản lý đơn hàng"
                                : item.roleId === "63603ce36fbb022774f83faf"
                                ? "Quản lý tài khoản"
                                : item.roleId === "63644405f5beeb475cc01acc"
                                ? "Phân quyền quản trị"
                                : item.roleId === "63604156b949802220aa04c9"
                                ? "Khách hàng"
                                : null
                            }
                          >
          ...
          <div style={{ height: 600, width: "100%", marginLeft: "10px" }}>
            <DataGrid
              ...
              onSelectionModelChange={(ids) => {
                ...
                const selectedRows = roleactionInPage.filter((row) =>
